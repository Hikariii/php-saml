...
AUTHNREQUEST;
     ...
     *
     * @param bool $deflate Whether or not we should 'gzdeflate' the request body before we return it.
     * @return string
     */
    public function getRequest($deflate = true)
    {
