...
class IdPMetadataParser
{
     ...
     */
    public static function parseRemoteXML($url, $entityId = null)
    {
        $metadataInfo = array();
     ...
     * @return array metadata info in php-saml settings format
     */
    public static function parseFileXML($filePath, $entityId = null)
    {
        $metadataInfo = array();
    ...
    public static function parseXML($xml, $entityId = null, $desiredNameIdFormat = null)
    {
        ...
        try {
            ...
            if (isset($idpDescriptorNodes) && $idpDescriptorNodes->length > 0) {
                ...
                $ssoNodes = Utils::query($dom, './md:SingleSignOnService[@Binding="'.Constants::BINDING_HTTP_REDIRECT.'"]', $idpDescriptor);
                ...
                $sloNodes = Utils::query($dom, './md:SingleLogoutService[@Binding="'.Constants::BINDING_HTTP_REDIRECT.'"]', $idpDescriptor);
     ...
     * @param array $metadataInfo   metadata info
     *
     * @return array settings
     */
    public static function injectIntoSettings(array $settings, array $metadataInfo)
    {
